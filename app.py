...
## function to load Gemini Pro vision model and get respomse

def get_gemini_rsponse(input,image_data,input_prompt):
...
st.header("Gemini Invoice Analyst")
...
if submit:
    ...
    response=get_gemini_rsponse(input,image_data,input_prompt)
